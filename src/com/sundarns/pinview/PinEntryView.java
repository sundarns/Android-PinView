...
public class PinEntryView extends Activity {
    ...
    Button buttonExit;
    Button buttonDelete;
    // A Flag to check if the user is accessing the application for the first time or not
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Typeface xpressive = Typeface.createFromAsset(getAssets(),
                "fonts/XpressiveBold.ttf");
        ...
        // Use SharedPreferences to store / retrieve the PIN
        final SharedPreferences prefs = this.getSharedPreferences(
                "com.cognizant.isales", Context.MODE_PRIVATE);
        final String pinKey = "com.cognizant.isales.pin";
        String pin = prefs.getString(pinKey, new String());
        if (pin.equals("")) {
            firstTimeAccess = true;
            statusView.setText("This is your first time. Set your pin");
            Log.v("PinView", "First time access");
        } else {
            userPin = pin;
        }
                ...
                if (userEntered.length() < PIN_LENGTH) {
                    ...
                    if (userEntered.length() == PIN_LENGTH) {
                        ...
                        if (firstTimeAccess) {
                            ...
                            statusView.setText("Your PIN has been set");
                            Log.v("PinView", "New PIN set");
                            finish();
                            prefs.edit().putString(pinKey, userEntered)
                                    .commit();
                            firstTimeAccess = false;
                        } else {
                            ...
                            if (userEntered.equals(userPin)) {
                                ...
                                statusView.setText("Wrong PIN. Try Again.");
    ...
    public void onBackPressed() {
        ...
        // App not allowed to go back to Parent activity until correct pin
        // entered.
        return;
        // super.onBackPressed();
    }
